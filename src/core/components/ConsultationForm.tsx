...
export function ConsultationForm({ isOpen, onClose }: { isOpen: boolean; onClose: () => void }) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const selectedService = formData.service || "Website Development"
      const projectType = formData.service || "Website Development"
      ...
      const response = await fetch("/api/form-submission", {
        ...
        body: JSON.stringify({
          ...
          timeline: formData.bestTime || "Not specified",
          message: formData.description || "",
          selectedService,
          formSource: "webdevelopment-popup",
        }),
      })
      ...
      if (result.success) {
        ...
        // Optional: open WhatsApp link generated by backend
      ...
      console.error("ConsultationForm submission error:", error)
      setSubmitStatus("error")
      alert("Submission failed. Please try again.")
    } finally {
