...
export default function BlogAdminPage() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-t via-p-3 to-t pt-20 md:pt-12 font-avant-garde">
        ...
        >
          <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4 mb-6">
            ...
            <Button 
              ...
              className="bg-gradient-to-r from-blue to-p hover:from-t hover:to-p-2 text-white px-6 py-3 rounded-xl font-semibold shadow-lg hover:shadow-xl transition-all duration-300 transform hover:scale-105"
            >
                            ...
                            <div className="flex items-center gap-3 mb-2">
                              ...
                              >
                                {blog.status === 'published' ? (
                                  <><Eye className="w-3 h-3 mr-1 text-white" /> Published</>
                                ) : (
                                  <><EyeOff className="w-3 h-3 mr-1 text-white" /> Draft</>
                                )}
                              </Badge>
                            </div>
                            ...
                            <div className="flex flex-wrap gap-2 mb-3">
                              {blog.tags.map((tag, tagIndex) => (
                                <Badge
                                  key={tagIndex}
                                  variant="outline"
                                  className="bg-blue/10 text-blue-200 border-blue/30 text-xs"
                                >
