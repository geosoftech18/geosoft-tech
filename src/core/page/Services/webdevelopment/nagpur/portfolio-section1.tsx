            ...
            >
              ...
              <div className="relative h-64 overflow-hidden">
                ...
                {(hoveredCard === item.id || clickedCard === item.id) && (
                  <motion.div
                    className="absolute bottom-2 left-1/2 transform -translate-x-1/2 z-20 flex text-center items-center gap-2"
                    initial={{ opacity: 0, y: 10 }}
                    animate={{ opacity: 1, y: 0 }}
                    transition={{ delay: 0.5 }}
                  >
                    <div onClick={() => window.open(item.link, "_blank")} className="bg-yellow-400/90 backdrop-blur-sm text-white px-2 py-1 rounded-full text-xs font-medium">
                      Full Page View
                    </div>
                    <div onClick={() => window.open(item.link, "_blank")} className="bg-white/90 backdrop-blur-sm text-gray-700 px-2 py-1 rounded-full text-xs font-medium">
                     Visit
                    </div>
