    ...
    <section id="contact" className="py-12 sm:py-16 md:py-20 bg-[#00bf62] text-primary-foreground">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-12 sm:mb-16">
          ...
          If you’re searching for a professional website designing company in Pune, GEO Softech is your trusted partner. We don’t just build websites – 
          we create digital growth platforms that help your business attract, engage, and convert customers. 
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 sm:gap-12 items-center">
          <div>
            ...
            Whether you need a startup website, corporate platform, or e-commerce solution, our team ensures 
            your digital presence is future-ready and growth-driven. 
            </p>
