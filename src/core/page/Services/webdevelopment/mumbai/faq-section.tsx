...
const faqs = [
  {
    question: "Which is the best website designing company in Mumbai?",
    answer:
      "GEO Softech is one of the leading web design and development companies in Mumbai with 7+ years of experience and over 300 successful projects across various industries.",
  },
  {
    question: "How much does website designing cost in Mumbai?",
    answer:
      "The cost depends on project requirements. At GEO Softech, we offer affordable and customized packages starting from basic websites to advanced e-commerce platforms. Contact us for a free consultation and quote.",
  },
  {
    question: "Do you provide e-commerce website development in Mumbai?",
    answer:
  ...
  {
    question: "Why choose a Mumbai-based company for web design?",
    answer:
      "A local website design agency in Mumbai like GEO Softech understands market trends, audience needs, local business requirements, and provides faster support and communication.",
  },
]
