...
const services = [
  {
    ...
    description:
      "Professional websites for brands, companies, and enterprises that establish credibility and drive business growth.",
  ...
  },
  {
    ...
    description: "WordPress, Shopify, Magento, and custom-built solutions tailored to your specific business needs.",
    ...
    <section id="services" className="py-12 sm:py-16 md:py-20 bg-muted/30">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-12 sm:mb-16">
          ...
          GEO Softech extends a comprehensive suite of{" "}
            <Link href="/services/webdevelopment" className="font-medium text-[#00bf62] underline underline-offset-2 hover:text-[#00994e]">
              web design and development
            </Link>
            {" "}in Mumbai. Each service is calibrated to resonate with your distinct business ethos and propel expansion in the digital realm.
          </p>
        </div>
                    ...
                    {services
                      ...
                      .map((service, index) => (
                        <Card
                          ...
                          className="group hover:shadow-xl hover:scale-105 transition-all duration-500 border-border bg-[#00bf62]/5 backdrop-blur hover:bg-card"
                        >
                          <CardHeader>
