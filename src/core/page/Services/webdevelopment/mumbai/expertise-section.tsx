        ...
        <div className="relative mb-12 sm:mb-16 lg:mb-20">
          ...
          <div className="flex items-center justify-center gap-4 mt-8">
            <Button
              ...
              size="icon"
              onClick={prevSlide}
              className="rounded-full !p-0 group border-2 hover:bg-[#00bf62] hover:text-white transition-colors bg-transparent"
            >
            ...
            <div className="flex gap-2">
              {Array.from({ length: Math.ceil(whyChooseUs.length / 3) }).map((_, index) => (
                <button
                  ...
                  className={`w-3 h-3 rounded-full transition-colors !p-0 ${
            ...
            <Button
              ...
              size="icon"
              onClick={nextSlide}
              className="rounded-full border-2 !p-0 group hover:bg-[#00bf62] hover:text-white transition-colors bg-transparent"
            >
          ...
          <div className="relative">
                ...
                <div className="flex md:hidden w-full">
                  {websiteBenefits.map((benefit, index) => (
                    <div key={index} className="w-full flex-shrink-0 px-4">
                      <div className="text-center bg-[#00bf62]/5 rounded-xl p-6 shadow-sm border border-border hover:shadow-md transition-all duration-300">
                  ...
                  {Array.from({ length: Math.ceil(websiteBenefits.length / 2) }).map((_, slideIndex) => (
                    <div key={slideIndex} className="w-full flex-shrink-0 flex gap-6 px-4">
                      {websiteBenefits.slice(slideIndex * 2, slideIndex * 2 + 2).map((benefit, index) => (
                        <div key={index} className="w-1/2">
                          <div className="text-center bg-[#00bf62]/5 rounded-xl p-6 shadow-sm border border-border hover:shadow-md transition-all duration-300 h-full">
                  ...
                  {Array.from({ length: Math.ceil(websiteBenefits.length / 4) }).map((_, slideIndex) => (
                    <div key={slideIndex} className="w-full flex-shrink-0 flex gap-6 px-4">
                      {websiteBenefits.slice(slideIndex * 4, slideIndex * 4 + 4).map((benefit, index) => (
                        <div key={index} className="w-1/3">
                          <div className="text-center bg-[#00bf62]/5 rounded-xl p-6 shadow-sm border border-border hover:shadow-md transition-all duration-300 hover:scale-105 h-full">
                            <div className="p-3 bg-[#00bf62]/10 rounded-full w-fit mx-auto mb-4">
                              <TrendingUp className="h-6 w-6 text-[#00bf62]" />
                            </div>
                            <p className="text-sm font-semibold text-foreground">{benefit}</p>
            ...
            <div className="flex items-center justify-center gap-4 mt-8">
              <Button
                ...
                className="rounded-full !p-0  hover:bg-[#00bf62]/10 transition-colors"
              >
              ...
              <div className="flex gap-2">
                {Array.from({ length: Math.ceil(websiteBenefits.length / 3) }).map((_, index) => (
                  <button
                    ...
                    className={`w-2 h-2 rounded-full transition-all duration-300 !p-0 ${
              ...
              <div className="flex gap-3">
                {Array.from({ length: Math.ceil(milestones.length / 3) }).map((_, index) => (
                  <button
                    ...
                    className={`h-3 rounded-full transition-all duration-300 !p-0 ${
                      timelineSlide === index
