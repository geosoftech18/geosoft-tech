...
export function CTASection() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      console.error("Mumbai CTA submission error:", err)
      setSubmitStatus("error")
      alert("Submission failed. Please try again.")
    } finally {
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-12 sm:mb-16">
          ...
          <p className="text-base sm:text-lg md:text-xl text-primary-foreground/80 max-w-3xl mx-auto text-pretty">
            If you are looking for a professional website designing company in Mumbai that can deliver creative,
            responsive, and business-oriented websites, GEO Softech is your trusted partner.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 sm:gap-12 items-center">
          <div>
            ...
            <p className="text-sm sm:text-base text-primary-foreground/90 mb-6 sm:mb-8">
              Whether you need a startup website, corporate platform, or an e-commerce store, our team ensures a perfect
              balance of design, technology, and strategy.
            </p>
            ...
            <div className="flex flex-col sm:flex-row gap-3 sm:gap-4">
              <Button
                size="lg"
                variant="secondary"
                className="bg-yellow-600 hover:bg-yellow-600/90 text-white text-sm sm:text-base"
                onClick={() => window.open("tel:+917776085112", "_blank")}
              >
                <Phone className="mr-2 h-4 w-4 sm:h-5 sm:w-5 text-white" />
                Call Now
              </Button>
              <Button
                size="lg"
                ...
                onClick={() => window.open("https://wa.me/917776085112", "_blank")}
              >
                <MessageCircle className="mr-2 h-4 w-4 sm:h-5 sm:w-5 text-white hover:text-black" />
                WhatsApp Chat
              </Button>
            </div>
          </div>
        ...
        <div className="text-center mt-12 sm:mt-16">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4 sm:gap-6 text-xs sm:text-sm">
            ...
            >
              ...
              <span className="text-white">+91 77760 85112</span>
            </div>
            <div className="flex items-center gap-2">
              <Mail className="h-3 w-3 sm:h-4 sm:w-4 text-white" />
              <span className="text-white">info@geosoftech.com</span>
            </div>
            <div className="flex items-center gap-2">
