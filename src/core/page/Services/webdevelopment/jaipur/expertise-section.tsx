...
const whyChooseUs = [
  {
    ...
    description: "As a Jaipur-based website designing company, we understand local markets and customer behavior.",
  },
  {
    icon: Palette,
  ...
  },
  {
    ...
    description: "From startups to corporates, we provide cost-effective website design services in Jaipur.",
  },
]
...
const benefits = [
  ...
  "Local + Global Reach – Target Jaipur customers while expanding to global markets. ",
]
          ...
          <div className="relative">
            ...
            <div className="flex items-center justify-center gap-4 mt-8">
              <Button
                ...
                className="rounded-full !p-0 group hover:bg-[#00bf62]/10 transition-colors"
              >
          ...
          <div className="relative">
            ...
            <div className="flex items-center justify-center gap-4 mt-10 md:hidden">
              <Button
                ...
                className="rounded-full !p-0 group border-2 hover:bg-[#00bf62] hover:text-white transition-all duration-300 bg-transparent shadow-sm"
              >
                <ChevronLeft className="h-4 w-4 group-hover:text-white" />
              </Button>
