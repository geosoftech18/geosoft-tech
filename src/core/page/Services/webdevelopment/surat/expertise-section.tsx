...
const whyChooseUs = [
  {
    ...
    description: "As a Surat-based website designing company, we understand local markets and customer behavior.",
  },
  {
    icon: Palette,
  ...
  },
  {
    ...
    description: "From startups to corporates, we provide cost-effective website design services in Surat.",
  },
]
...
const benefits = [
  ...
  "Local + Global Reach – Target Surat customers while expanding to global markets. ",
]
    ...
    <section className="py-12 sm:py-16 md:py-20">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-7xl">
        ...
        <div className="text-center mb-12 sm:mb-16">
          ...
          Why GEO SofTech is Recognized as the Best Web Design Company in Surat? 
          </h2>
        ...
        <div className="mb-12 sm:mb-16 lg:mb-20 bg-muted/30 rounded-2xl p-6 sm:p-8 md:p-12">
          ...
          Why Surat Businesses Need a Professional Website 
          </h3>
          <p className="text-base sm:text-lg text-muted-foreground mb-6 sm:mb-8 text-center max-w-3xl mx-auto">
          With the rise of AI, automation, and personalized user experiences, web design is no longer just about looks—it’s about performance and adaptability. At GEO SofTech, 
          we lead the way in custom website UI/UX development in Surat, ensuring your business is always ahead of trends. 
          </p>
