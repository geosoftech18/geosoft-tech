        ...
        <div className="max-w-4xl">
          <Breadcrumb
            ...
            items={[
              ...
              { name: 'Surat', href: '/services/webdevelopment/surat-development' },
            ]}
          />
          <div className="flex items-center gap-2 mb-6">
            <MapPin className="h-5 w-5 text-[#00bf62]" />
            <span className="text-sm font-medium text-muted-foreground">Surat, India</span>
          </div>
          ...
          <h1 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl xl:text-5xl font-bold text-foreground mb-4 sm:mb-6 text-balance leading-tight">
            GEO Softech – Professional <span className="text-[#00bf62]">Website Designing Company </span> in Surat
          </h1>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 sm:gap-6 lg:gap-8">
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                <div className="text-xl sm:text-2xl font-bold text-foreground">Surat</div>
